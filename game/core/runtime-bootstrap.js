/* Dungeon Echo production UX bootstrap v24.
 * v1.3.3 audio/UX hotfix on cache generation 172.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v133.js'), 'data-de-release-stamp-v133', () => !!window.__DE_RELEASE_STAMP_V133],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v24');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v24', assetVersion, locale:english?'en':'zh-CN',
