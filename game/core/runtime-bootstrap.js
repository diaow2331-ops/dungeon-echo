/* Dungeon Echo production UX bootstrap v38.
 * v1.9.6 HUD dirty-update + render-cache release on cache generation 196.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v196.js'), 'data-de-release-stamp-v196', () => !!window.__DE_RELEASE_STAMP_V196],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v38');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v38', assetVersion, locale:english?'en':'zh-CN',
