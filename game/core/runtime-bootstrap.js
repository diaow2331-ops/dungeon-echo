/* Dungeon Echo production UX bootstrap v41.
 * v1.9.9 incremental combat-log DOM release on cache generation 199.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v199.js'), 'data-de-release-stamp-v199', () => !!window.__DE_RELEASE_STAMP_V199],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v41');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v41', assetVersion, locale:english?'en':'zh-CN',
