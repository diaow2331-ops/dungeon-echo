/* Dungeon Echo production UX bootstrap v37.
 * v1.9.5 render-lifecycle + interaction-performance release on cache generation 195.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v195.js'), 'data-de-release-stamp-v195', () => !!window.__DE_RELEASE_STAMP_V195],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v37');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v37', assetVersion, locale:english?'en':'zh-CN',
