/* Dungeon Echo production UX bootstrap v32.
 * v1.6.0 modular-authority release on cache generation 180.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v160.js'), 'data-de-release-stamp-v160', () => !!window.__DE_RELEASE_STAMP_V160],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v32');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v32', assetVersion, locale:english?'en':'zh-CN',
