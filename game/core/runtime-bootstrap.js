/* Dungeon Echo production UX bootstrap v39.
 * v1.9.7 static-scene layer + visibility-filter cache release on cache generation 197.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v197.js'), 'data-de-release-stamp-v197', () => !!window.__DE_RELEASE_STAMP_V197],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v39');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v39', assetVersion, locale:english?'en':'zh-CN',
