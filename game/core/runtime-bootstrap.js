/* Dungeon Echo production UX bootstrap v23.
 * v1.3.2 recovery patch on cache generation 171.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v132.js'), 'data-de-release-stamp-v132', () => !!window.__DE_RELEASE_STAMP_V132],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v23');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v23', assetVersion, locale:english?'en':'zh-CN',
