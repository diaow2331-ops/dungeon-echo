/* Dungeon Echo production UX bootstrap v36.
 * v1.9.4 gameplay-depth + decision-clarity release on cache generation 194.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v194.js'), 'data-de-release-stamp-v194', () => !!window.__DE_RELEASE_STAMP_V194],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v36');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v36', assetVersion, locale:english?'en':'zh-CN',
