/* Dungeon Echo production UX bootstrap v31.
 * v1.5.0 gameplay-feedback release on cache generation 179.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v150.js'), 'data-de-release-stamp-v150', () => !!window.__DE_RELEASE_STAMP_V150],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v31');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v31', assetVersion, locale:english?'en':'zh-CN',
