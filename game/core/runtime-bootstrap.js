/* Dungeon Echo production UX bootstrap v40.
 * v1.9.8 dynamic-gradient cache + high-DPI audit release on cache generation 198.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v198.js'), 'data-de-release-stamp-v198', () => !!window.__DE_RELEASE_STAMP_V198],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v40');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v40', assetVersion, locale:english?'en':'zh-CN',
