/* Dungeon Echo production UX bootstrap v25.
 * v1.3.4 gameplay hotfix on cache generation 173.
...
(() => {
  ...
  const chain = Object.freeze([
    [fresh('game/core/release-stamp-v134.js'), 'data-de-release-stamp-v134', () => !!window.__DE_RELEASE_STAMP_V134],
  ...
  function loadScript(src, marker, ready) {
    return new Promise(resolve => {
      ...
      script.src = src;
      script.async = false;
      script.setAttribute(marker, 'v25');
      let done = false;
  ...
  window.__DE_PRODUCTION_UX_BOOTSTRAP = Object.freeze({
    version:'v25', assetVersion, locale:english?'en':'zh-CN',
