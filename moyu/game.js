...
function sampleNormalGapPx(spawned){
  ...
  let bands;
  if(runDistance<360){bands=[{w:.12,a:520,b:620},{w:.52,a:680,b:850},{w:.36,a:920,b:1180}]}
...
function drawGameFeelFx(){
  ...
  if(feelFlash>0){const a=Math.min(.16,feelFlash*(feelKind==='perfect'?1.15:.68));ctx.globalAlpha=a;ctx.fillStyle=feelKind==='perfect'?'#d8ef9f':((feelKind==='boss'||feelKind==='hurt')?'#d95a49':'#fffdf8');ctx.fillRect(0,0,W,H)}
