...
run_gate res://tests/npc_bounty_test.gd 'wildforge_npc_bounty=PASS'
run_gate res://tests/npc_bounty_save_test.gd 'wildforge_npc_bounty_save=PASS'
run_gate res://tests/player_prison_test.gd 'wildforge_player_prison=PASS'
...
run_gate res://tests/world_intervention_guidance_test.gd 'wildforge_world_intervention_guidance=PASS'
...
run_gate res://tests/warehouse_crime_pressure_test.gd 'wildforge_warehouse_crime_pressure=PASS'
run_gate res://tests/player_crime_progression_test.gd 'wildforge_player_crime_progression=PASS'
run_gate res://tests/guard_crime_pressure_test.gd 'wildforge_guard_crime_pressure=PASS'
