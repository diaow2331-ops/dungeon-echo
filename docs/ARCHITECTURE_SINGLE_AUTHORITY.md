...
- combat owns the canonical critical-damage multiplier and (since v1.9.2) the pure ordinary-monster threat/HP/DEF pressure curves; elite rolls, spawn composition, engagement strikes, defense, damage application and turn consequences remain core-owned.
