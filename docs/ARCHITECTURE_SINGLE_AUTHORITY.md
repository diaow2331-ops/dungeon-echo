...
- combat owns the canonical critical-damage multiplier, (since v1.9.2) the pure ordinary-monster threat/HP/DEF pressure curves, and (since v1.9.3) the guardian fury soft-enrage curve; elite rolls, fury engagement counters, spawn composition, engagement strikes, defense, damage application and turn consequences remain core-owned.
