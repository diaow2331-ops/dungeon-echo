...
| --- | --- | --- | --- |
| Dungeon Echo | v1.5.0 | `VERSION` | `ops/release/build-site-bundle.sh` |
| Clock Out Alive / 摸鱼到下班 | v1.26.5 | `moyu/VERSION` | `ops/release/build-moyu-bundle.sh` |
| Board Trio / 方寸棋局 | v0.1.1 | `board-games/VERSION` | `ops/release/build-board-games-bundle.sh` |
| 91hwl public site | v1.11.2 | `ops/home-mount/SITE_VERSION` | `ops/release/build-home-mount-bundle.sh` |
