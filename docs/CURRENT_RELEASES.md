...
| Board Trio / 方寸棋局 | v0.3.0 | `board-games/VERSION` | `ops/release/build-board-games-bundle.sh` |
| 91hwl public site | v1.11.5 | `ops/home-mount/SITE_VERSION` | `ops/release/build-home-mount-bundle.sh` |
