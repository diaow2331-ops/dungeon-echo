...
The second presentation pass adds a fixed 4 × 4 building atlas. Plaza construction cards and every affected service page now show the exact stage-0/1/2/3 form of the smithy, market, tavern or Relic Hall instead of asking text and tiny procedural marks to carry the entire progression.
...
Those identities now have a fixed 9 × 6 atlas: each set owns four class-appropriate weapon cells plus its authored armor, helmet, boots, ring and amulet. The same cell follows an item through ground loot, bag, equipment bar and Relic Hall collection view, preventing its story from collapsing back into a generic rarity icon.
