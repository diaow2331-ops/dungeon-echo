...
function drawTile(tx,ty,id) {
  ...
  if(id===TILE.LEAF||id===TILE.GLOW_MOSS||id===TILE.TORCH||id===TILE.CAMPFIRE||id===TILE.RUIN_SPIKE||id===TILE.RUIN_URN){drawNonSolidTile(x,y,s,id,def);return;}
