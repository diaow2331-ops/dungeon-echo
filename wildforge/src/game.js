...
function applySave(raw) {
  ...
  game.frontier=sanitizeFrontierSimulation(raw.frontier,{seed:game.seed,settlements:game.world.settlements||[],day:game.nightsSurvived});
