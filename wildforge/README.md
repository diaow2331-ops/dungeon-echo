...
Wildforge is an original browser-native 2D sandbox survival game designed landscape-first for desktop and touch devices. The current v0.1.0 branch is an incubation baseline, not a public production release.

## v0.1.0 playable baseline
