...
Presented releases:
- Dungeon Echo v1.2.11 — 100-floor browser roguelike with the current expedition-pressure, input and responsive release surface.
...
Release safety packages final static bytes only, verifies SHA256 before writing, backs up the currently live homepage/detail/trust paths, uses atomic file replacement, validates Nginx, checks the visible v1.3.5 trust hub plus Dungeon Echo v1.2.11 / Clock Out Alive v1.11.5 public contracts, and rolls back owned site paths if validation fails.
