...
- Board Trio / 方寸棋局 v0.3.0 — Gomoku, Xiangqi and Go in one responsive local two-player board-game shell.

site v1.11.5 keeps the current three-game composition, preserves Dungeon Echo v1.5.0 and refreshes Board Trio to v0.3.0 with a fuller local-match rules loop: Go scoring agreement, dead-group marking, whole-board repetition prevention, resume play and guarded resignation.
