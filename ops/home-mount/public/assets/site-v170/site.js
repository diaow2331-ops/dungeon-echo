...
let lang=window.__91HWL_PREFS?.lang||qs.get('lang')||readCookie('91hwl_lang')||localStorage.getItem(LK)||'zh';
let theme=window.__91HWL_PREFS?.theme||qs.get('theme')||readCookie('91hwl_theme')||localStorage.getItem(TK)||'dark';
