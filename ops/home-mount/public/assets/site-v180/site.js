...
const randomChoice=()=>{const box=document.querySelector('[data-draw-result]');if(box)box.classList.add('is-drawing');setTimeout(()=>{choose(Math.random()<.5?'dungeon':'moyu');if(box)box.classList.remove('is-drawing')},360)};
