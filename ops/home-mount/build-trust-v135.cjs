...
const trustHub = `<section class="site-trust-hub" aria-labelledby="site-trust-title">
  ...
  <div class="site-trust-grid">
    ...
    <article class="site-trust-card"><small>03 / CONTACT</small><h3><span class="i18n-zh">联系与反馈</span><span class="i18n-en">Contact &amp; feedback</span></h3><p><span class="i18n-zh">可复现 Bug 和技术问题优先走 GitHub Issues；站点事务、合作或隐私请求可以直接发邮件。</span><span class="i18n-en">Reproducible bugs and technical issues are best filed on GitHub Issues; site matters, collaboration and privacy requests can go by email.</span></p><a class="trust-mail" href="mailto:diaow2331@gmail.com">diaow2331@gmail.com</a><a class="trust-link" href="/contact/"><span class="i18n-zh">查看全部联系方式 →</span><span class="i18n-en">See contact options →</span></a></article>
  </div>
</section>`;
