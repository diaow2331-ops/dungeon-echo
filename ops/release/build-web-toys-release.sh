...
bash "$repo_root/ops/release/build-site-bundle.sh" "$out_dir/91hwl-play-dungeon-echo-v$de_version.zip"
...
dungeon_echo_bundle=$out_dir/91hwl-play-dungeon-echo-v$de_version.zip
