...
test "$site_version" = '1.8.0' || { echo "unexpected site version: $site_version" >&2; exit 2; }
...
for file in \
  ...
  "$source_root/public/assets/site-v180/style.css" \
  "$source_root/public/assets/site-v180/site.js" \
  "$source_root/public/assets/site-v180/wang-jian-landscape-1668.jpg" \
  "$source_root/public/assets/site-v180/moyu-run-v1230.jpg" \
...
mkdir -p \
  ...
  "$stage_root/site/public/assets/site-v180"
...
cp "$source_root/public/assets/site-v180/"* "$stage_root/site/public/assets/site-v180/"
...
grep -Fq 'data-site-version="1.8.0"' "$home"
...
grep -Fq 'site-v180/style.css' "$home"
grep -Fq 'site-v180/site.js' "$home"
grep -Fq 'id="navToggle"' "$home"
grep -Fq 'game-media-moyu' "$home"
grep -Fq 'draw-stick' "$home"
grep -Fq 'data-site-version="1.8.0"' "$de_detail"
...
grep -Fq 'data-site-version="1.8.0"' "$moyu_detail"
...
grep -Fq 'privacy-emblem' "$privacy"
grep -Fq '重置主站偏好' "$privacy"
grep -Fq '把问题说清，把回音留下。' "$contact"
grep -Fq 'record-letter' "$contact"
...
grep -Fq "test \"\$version\" = '1.8.0'" "$source_root/deploy.sh"
...
grep -Fq 'site-v180/style.css' "$source_root/deploy.sh"
grep -Fq '敬请期待' "$source_root/deploy.sh"
grep -Fq 'mailto:diaow2331@gmail.com' "$source_root/deploy.sh"
grep -Fq 'web-toys-v180' "$source_root/deploy.sh"
...
grep -Fq 'public site v1.8.0 check failed' "$source_root/healthcheck.sh"
grep -Fq 'site-v180/style.css' "$source_root/healthcheck.sh"
...
mkdir -p \
  ...
  "$bundle/public/assets/site-v180" \
  "$bundle/ops"
...
install -m 0644 "$stage_root/site/public/assets/site-v180/style.css" "$bundle/public/assets/site-v180/style.css"
install -m 0644 "$stage_root/site/public/assets/site-v180/site.js" "$bundle/public/assets/site-v180/site.js"
install -m 0644 "$stage_root/site/public/assets/site-v180/wang-jian-landscape-1668.jpg" "$bundle/public/assets/site-v180/wang-jian-landscape-1668.jpg"
install -m 0644 "$stage_root/site/public/assets/site-v180/moyu-run-v1230.jpg" "$bundle/public/assets/site-v180/moyu-run-v1230.jpg"
