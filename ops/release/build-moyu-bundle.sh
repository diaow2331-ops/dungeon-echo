...
grep -Fq 'display:124' "$source_root/game.js"
...
grep -Fq "assets/sprites/hero-v125.webp?v=1261" "$source_root/game.js"
...
grep -Fq 'assets/scenes-v126/workstation.svg?v=1261' "$source_root/game.js"
