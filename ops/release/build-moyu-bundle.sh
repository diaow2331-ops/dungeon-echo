...
grep -Fq "assets/sprites/hero-v125.webp?v=1262" "$source_root/game.js"
...
grep -Fq 'assets/scenes-v126/workstation.svg?v=1262' "$source_root/game.js"
...
grep -Fq 'const top=0,h=GROUND+1' "$source_root/game.js"
