...
grep -Fq 'display:148' "$source_root/game.js"
...
grep -Fq "assets/sprites/hero-v125.webp?v=1264" "$source_root/game.js"
...
grep -Fq 'assets/scenes-v126/workstation.svg?v=1264' "$source_root/game.js"
...
grep -Fq 'const srcW=1920,srcTop=82,srcBottom=820,contentEnd=[604,545,442,480][i],srcFloor=604,worldJoin=[442,438,432,436][i],floorBottom=H-28' "$source_root/game.js"
