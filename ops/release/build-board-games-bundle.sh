...
test "$version" = '0.5.0'
[[ "$revision" =~ ^[0-9a-f]{40}$ ]]
files=(VERSION index.html style.css rules.js ai.js ai-worker.js game.js)
...
grep -Fq '<meta name="version" content="0.5.0"' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=050' "$bundle/public/board-games/index.html"
grep -Fq 'ai.js?v=050' "$bundle/public/board-games/index.html"
grep -Fq "dataset.gameVersion='0.5.0'" "$bundle/public/board-games/game.js"
node --check "$bundle/public/board-games/rules.js"; node --check "$bundle/public/board-games/ai.js"; node --check "$bundle/public/board-games/ai-worker.js"; node --check "$bundle/public/board-games/game.js"
