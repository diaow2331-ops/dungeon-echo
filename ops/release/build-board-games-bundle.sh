...
grep -Fq '<meta name="version" content="0.1.1"' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=011' "$bundle/public/board-games/index.html"
grep -Fq "dataset.gameVersion='0.1.1'" "$bundle/public/board-games/game.js"
