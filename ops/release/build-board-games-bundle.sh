...
grep -Fq '<meta name="version" content="0.6.0"' "$bundle/public/board-games/index.html"
grep -Fq 'ui.js?v=060' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=060' "$bundle/public/board-games/index.html"
grep -Fq 'ai.js?v=060' "$bundle/public/board-games/index.html"
...
grep -Fq "dataset.gameVersion='0.6.0'" "$bundle/public/board-games/game.js"
