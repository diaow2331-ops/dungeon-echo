...
grep -Fq '<meta name="version" content="0.7.0"' "$bundle/public/board-games/index.html"
grep -Fq 'ui.js?v=070' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=070' "$bundle/public/board-games/index.html"
grep -Fq 'ai.js?v=070' "$bundle/public/board-games/index.html"
...
grep -Fq 'id="goCaptureStats"' "$bundle/public/board-games/index.html"
grep -Fq 'id="goCaptureLayer"' "$bundle/public/board-games/index.html"
grep -Fq 'class="live-metrics"' "$bundle/public/board-games/index.html"
grep -Fq 'class="status-lockup"' "$bundle/public/board-games/index.html"
grep -Fq 'capturedStones' "$bundle/public/board-games/rules.js"
grep -Fq "dataset.gameVersion='0.7.0'" "$bundle/public/board-games/game.js"
