...
grep -Fq '<meta name="version" content="0.3.0"' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=030' "$bundle/public/board-games/index.html"
grep -Fq "dataset.gameVersion='0.3.0'" "$bundle/public/board-games/game.js"
