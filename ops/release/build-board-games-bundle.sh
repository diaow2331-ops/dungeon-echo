...
grep -Fq '<meta name="version" content="0.4.0"' "$bundle/public/board-games/index.html"
grep -Fq 'rules.js?v=040' "$bundle/public/board-games/index.html"
grep -Fq "dataset.gameVersion='0.4.0'" "$bundle/public/board-games/game.js"
