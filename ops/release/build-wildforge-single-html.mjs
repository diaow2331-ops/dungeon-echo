...
const js=[
  ...
  `const __WF_FRONTIER=(()=>{\n${frontierCode}\nreturn {FRONTIER_SIM_VERSION,FRONTIER_GOODS,FRONTIER_MAX_FACTIONS,FRONTIER_MAX_CARAVANS,createFrontierSimulation,sanitizeFrontierSimulation,stepFrontierSimulation,frontierSettlement,frontierEcology,frontierTarget,frontierMarketQuote,frontierDemandMap,frontierRelation,frontierRelationName,recordFrontierDelivery,recordFrontierThreatRemoval,frontierProsperityLevel,frontierThreatFactor,frontierWeatherName};\n})();`,
