...
const frontierCode=stripExports(stripImports(read('src/frontier-simulation.js')));
...
const js=[
  ...
  `const __WF_FRONTIER=(()=>{\n${frontierCode}\nreturn {FRONTIER_SIM_VERSION,FRONTIER_GOODS,FRONTIER_MAX_FACTIONS,FRONTIER_MAX_CARAVANS,createFrontierSimulation,sanitizeFrontierSimulation,stepFrontierSimulation,frontierSettlement,frontierEcology,frontierTarget,frontierMarketQuote,frontierDemandMap,frontierRelation,frontierRelationName,frontierFactionStatus,recordFrontierDelivery,recordFrontierAid,recordFrontierRaidResistance,recordFrontierThreatRemoval,frontierProsperityLevel,frontierThreatFactor,frontierWeatherName};\n})();`,
