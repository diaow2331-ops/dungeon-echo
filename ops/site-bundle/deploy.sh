...
for f in \
  ...
  "$GAME_SOURCE/game/core/runtime-bootstrap.js" "$GAME_SOURCE/game/core/release-stamp-v198.js" \
...
for entry in "$GAME_SOURCE/index.html" "$GAME_SOURCE/en/index.html"; do
  ...
  ! grep -Eq '\?v=(153|157|166|167|168|169|178|179|180|181|182|183|190|194|195|196|197)' "$entry" || fail "historical cache generation remains: $entry"
...
grep -Fq 'release-stamp-v198.js' "$GAME_SOURCE/game/core/runtime-bootstrap.js" || fail 'runtime release stamp mismatch'
