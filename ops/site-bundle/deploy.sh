...
for f in \
  ...
  "$GAME_SOURCE/game/core/runtime-bootstrap.js" "$GAME_SOURCE/game/core/release-stamp-v132.js" \
...
grep -Fq 'release-stamp-v132.js' "$GAME_SOURCE/game/core/runtime-bootstrap.js" || fail 'runtime release stamp mismatch'
