/* Dungeon Echo v1.2.3 visible release stamp. No timers or gameplay-state mutation. */
(() => {
  'use strict';
  if (typeof document === 'undefined' || window.__DE_RELEASE_STAMP_V123) return;
  const version = '1.2.3';
  ...
  window.__DE_RELEASE_STAMP_V123 = { version };
})();
