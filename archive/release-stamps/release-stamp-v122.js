/* Dungeon Echo v1.2.2 visible release stamp. No timers or state mutation. */
(() => {
  'use strict';
  if (typeof document === 'undefined' || window.__DE_RELEASE_STAMP_V122) return;
  const version = '1.2.2';
  ...
  window.__DE_RELEASE_STAMP_V122 = { version };
})();
