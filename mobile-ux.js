...
(() => {
  ...
  style.textContent=`
    html.de-mobile-ui body{overscroll-behavior-y:contain}
    html.de-mobile-ui #wrap{padding:6px 7px calc(8px + env(safe-area-inset-bottom));max-width:100%}
    ...
    html.de-mobile-ui #stage{width:100%;max-width:620px;justify-self:center;touch-action:manipulation}
    ...
    html.de-mobile-ui .pad{border-radius:9px;font-size:22px;min-width:0;min-height:0;-webkit-tap-highlight-color:transparent}
    html.de-mobile-ui #actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;align-content:center}
    html.de-mobile-ui #actions button{min-height:42px;padding:7px 5px;border-radius:8px;font-size:12px;font-weight:700;-webkit-tap-highlight-color:transparent}
