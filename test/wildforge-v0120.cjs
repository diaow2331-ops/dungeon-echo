...
assert.equal(read('wildforge/VERSION').trim(),'0.12.0');
assert(html.includes('<meta name="version" content="0.12.0"'));
assert(data.includes("VERSION = '0.12.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0120'"));
assert(html.includes('<meta name="version" content="0.12.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.12.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0120'"),'v0.9 save key missing');
...
console.log(`wildforge_v0120=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0120=PASS beacon_network=persistent');
...
console.log('wildforge_v0120=PASS route_network=supply-route');
...
console.log('wildforge_v0120=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0120=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0120=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0120=PASS depot_logistics=production-storage-capacity');
...
assert(html.includes('危险货运')&&html.includes('震落货物'),'haul risk is not surfaced to players');
console.log('wildforge_v0120=PASS haul_risk=weight-night-spill');
