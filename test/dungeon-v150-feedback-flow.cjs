...
ok(zh.includes('?v=196') && en.includes('?v=196'), 'both fixed locales publish cache generation 196');
ok(authority.version==='1.9.6' && authority.cacheGeneration===196, 'v1.9.6 release authority is version/cache coherent');
