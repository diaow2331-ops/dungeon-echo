...
ok(zh.includes('?v=197') && en.includes('?v=197'), 'both fixed locales publish cache generation 197');
ok(authority.version==='1.9.7' && authority.cacheGeneration===197, 'v1.9.7 release authority is version/cache coherent');
