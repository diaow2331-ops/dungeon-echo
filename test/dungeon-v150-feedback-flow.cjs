...
ok(zh.includes('?v=198') && en.includes('?v=198'), 'both fixed locales publish cache generation 198');
ok(authority.version==='1.9.8' && authority.cacheGeneration===198, 'v1.9.8 release authority is version/cache coherent');
