...
ok(zh.includes('?v=182') && en.includes('?v=182'), 'both fixed locales publish cache generation 182');
ok(authority.version==='1.8.0' && authority.cacheGeneration===182, 'v1.8 release authority is version/cache coherent');
