...
ok(zh.includes('?v=195') && en.includes('?v=195'), 'both fixed locales publish cache generation 195');
ok(authority.version==='1.9.5' && authority.cacheGeneration===195, 'v1.9.5 release authority is version/cache coherent');
