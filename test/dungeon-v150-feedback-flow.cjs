...
ok(siteVersion==='1.11.3' && homeBuilder.includes('build-site-v1112.cjs') && homeBuilder.includes('build-site-v1113.cjs'), 'Dungeon v1.5 companion stage remains in the immutable site chain through current v1.11.3');
