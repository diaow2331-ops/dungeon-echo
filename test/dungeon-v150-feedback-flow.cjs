...
ok(zh.includes('?v=194') && en.includes('?v=194'), 'both fixed locales publish cache generation 194');
ok(authority.version==='1.9.4' && authority.cacheGeneration===194, 'v1.9.4 release authority is version/cache coherent');
