...
assert.equal(read('wildforge/VERSION').trim(),'0.23.0');
assert(html.includes('<meta name="version" content="0.23.0"'));
assert(data.includes("VERSION = '0.23.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0230'"));
assert(html.includes('<meta name="version" content="0.23.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.23.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0230'"),'v0.9 save key missing');
...
console.log(`wildforge_v0230=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0230=PASS beacon_network=persistent');
...
console.log('wildforge_v0230=PASS route_network=supply-route');
...
console.log('wildforge_v0230=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0230=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0230=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0230=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0230=PASS hotfix-save-migration');
...
console.log('wildforge_v0230=PASS visual_foundation=pixel-atlas');
...
console.log('wildforge_v0230=PASS settlement-demand-destinations');
console.log('wildforge_v0230=PASS surface-inventory-knockback-expansion');
console.log('wildforge_v0230=PASS terraria_like_controls=fixed-step-context-use-camera');
...
console.log('wildforge_v0230=PASS foundation_feel=large-settlement-real-pack-pass-through-trees');
...
console.log('wildforge_v0230=PASS visual_spiral=biomes-settlements-depots');
...
console.log('wildforge_v0230=PASS settlement_memory=preference-reliability-causality');
