...
assert(core.includes('ctx.drawImage(staticLayer, vx, vy, vw, vh, vx, vy, vw, vh);'));
assert(core.includes('makeRenderLayer(view.cols * TILE, view.rows * TILE)'));
assert(core.includes('ctx.drawImage(visibilityLayer, view.x * TILE, view.y * TILE);'));
