...
ok(/PERSISTENT_PREF_KEYS = new Set\(\['de-guide-v1', 'de-audio-v1', 'de-expedition-record-v1', 'de-greedy-on-v1'\]\)/.test(bootstrap), 'fresh adventure preserves onboarding, audio, cross-run record and requested Greedy mode');
