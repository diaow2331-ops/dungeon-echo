...
assert.strictEqual(version,'1.4.2');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=178'));
...
assert(runtime.includes("version:'v30'")&&runtime.includes("const assetVersion = '178'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v142.js']) assert(manifest.includes(file));
