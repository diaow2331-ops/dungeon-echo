...
assert.strictEqual(version,'1.3.3');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=172'));
...
assert(runtime.includes("version:'v24'")&&runtime.includes("const assetVersion = '172'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v133.js']) assert(manifest.includes(file));
