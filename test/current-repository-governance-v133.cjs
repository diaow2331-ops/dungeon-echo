...
assert.strictEqual(version,'1.4.1');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=177'));
...
assert(runtime.includes("version:'v29'")&&runtime.includes("const assetVersion = '177'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v141.js']) assert(manifest.includes(file));
