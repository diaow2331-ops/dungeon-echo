...
assert.strictEqual(version,'1.3.6');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=175'));
...
assert(runtime.includes("version:'v27'")&&runtime.includes("const assetVersion = '175'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v136.js']) assert(manifest.includes(file));
