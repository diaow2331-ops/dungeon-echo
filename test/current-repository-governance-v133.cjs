...
assert.strictEqual(version,'1.3.5');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=174'));
...
assert(runtime.includes("version:'v26'")&&runtime.includes("const assetVersion = '174'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v135.js']) assert(manifest.includes(file));
