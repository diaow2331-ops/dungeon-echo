...
assert.strictEqual(version,'1.4.0');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=176'));
...
assert(runtime.includes("version:'v28'")&&runtime.includes("const assetVersion = '176'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v140.js']) assert(manifest.includes(file));
