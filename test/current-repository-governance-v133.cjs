...
assert.strictEqual(version,'1.3.2');
for(const entry of [index,english]){
  assert(entry.includes('game/core/game.js?v=171'));
...
assert(runtime.includes("version:'v23'")&&runtime.includes("const assetVersion = '171'"));
...
for(const file of ['index.html','en/index.html','style.css','game/core/game.js','art/hero-action-atlas-v2.svg','game/core/release-stamp-v132.js']) assert(manifest.includes(file));
