...
assert.equal(siteVersion,'1.5.0');
...
// and the v1.5.0 clarity/version postprocessor.
...
for(const script of ['ops/home-mount/build-v134.cjs','ops/home-mount/build-social-v134.cjs','ops/home-mount/build-trust-v135.cjs','ops/home-mount/build-home-v140.cjs','ops/home-mount/build-home-v150.cjs']){
...
assert.match(sourceDeploy,/test "\$version" = '1\.5\.0'/);
...
assert.match(sourceDeploy,/site-home-v150/);
...
assert.match(sourceDeploy,/web-toys-v150/);
...
assert.match(sourceHealth,/public site v1\.5\.0 check failed/);
assert.match(sourceHealth,/site-home-v150/);
...
assert.match(bundledHome,/data-site-version="1\.5\.0"/);
...
assert.match(bundledHome,/site-home-v150/);
...
assert.doesNotMatch(bundledHome,/site-home-v140|site-trust-hub-v135/);
...
assert.match(bundledDe,/data-site-version="1\.5\.0"/);
...
assert.match(bundledMoyu,/data-site-version="1\.5\.0"/);
...
console.log('RESULT  91hwl site v1.5.0 Chinese editorial + future-game slot contract PASS');
