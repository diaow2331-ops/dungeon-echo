...
const tmp=fs.mkdtempSync(path.join(os.tmpdir(),'web-toys-home-v134-'));
...
console.log('RESULT  91hwl site v1.3.4 immutable-artifact + trust/AdSense surface contract PASS');
