...
assert.equal(read('wildforge/VERSION').trim(),'0.19.0');
assert(html.includes('<meta name="version" content="0.19.0"'));
assert(data.includes("VERSION = '0.19.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0190'"));
assert(html.includes('<meta name="version" content="0.19.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.19.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0190'"),'v0.9 save key missing');
...
console.log(`wildforge_v0190=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0190=PASS beacon_network=persistent');
...
console.log('wildforge_v0190=PASS route_network=supply-route');
...
console.log('wildforge_v0190=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0190=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0190=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0190=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0190=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0190=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0190=PASS hotfix-save-migration');
...
console.log('wildforge_v0190=PASS visual_foundation=pixel-atlas');
...
assert(html.includes('运输委托')&&html.includes('Drive 像素图集'),'v0.19 contract/art loop is not surfaced on start screen');
console.log('wildforge_v0190=PASS settlement-demand-destinations');
console.log('wildforge_v0190=PASS surface-inventory-knockback-expansion');
console.log('wildforge_v0190=PASS terraria_like_controls=fixed-step-context-use-camera');
