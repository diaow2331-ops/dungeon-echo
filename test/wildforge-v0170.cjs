...
assert.equal(read('wildforge/VERSION').trim(),'0.17.0');
assert(html.includes('<meta name="version" content="0.17.0"'));
assert(data.includes("VERSION = '0.17.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0170'"));
assert(html.includes('<meta name="version" content="0.17.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.17.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0170'"),'v0.9 save key missing');
...
console.log(`wildforge_v0170=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0170=PASS beacon_network=persistent');
...
console.log('wildforge_v0170=PASS route_network=supply-route');
...
console.log('wildforge_v0170=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0170=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0170=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0170=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0170=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0170=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0170=PASS hotfix-save-migration');
...
console.log('wildforge_v0170=PASS visual_foundation=pixel-atlas');
...
assert(html.includes('地表聚落')&&html.includes('每日需求订单'),'v0.17 settlement loop is not surfaced on start screen');
console.log('wildforge_v0170=PASS settlement-demand-destinations');
console.log('wildforge_v0170=PASS surface-inventory-knockback-expansion');
console.log('wildforge_v0170=PASS terraria_like_controls=fixed-step-context-use-camera');
