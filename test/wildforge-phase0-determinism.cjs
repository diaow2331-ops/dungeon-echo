...
for(const marker of ["const SAVE_KEY = 'wildforge.save.v0430'","const LEGACY_SAVE_KEY_0420 = 'wildforge.save.v0420'","raw.v==='0.42.0'","const LEGACY_SAVE_KEY_0410 = 'wildforge.save.v0410'","raw.v==='0.41.0'","const LEGACY_SAVE_KEY_0230 = 'wildforge.save.v0230'","raw.v==='0.23.0'"])assert(game.includes(marker),'legacy migration contract missing: '+marker);
