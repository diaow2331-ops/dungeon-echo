...
const cleanup=fs.readFileSync(path.join(root,'game','ui','character-art-cleanup-v122.js'),'utf8');
...
const cleanupPos=runtime.indexOf("'game/ui/character-art-cleanup-v122.js'");
const lootPos=runtime.indexOf("'game/ui/world-loot-polish-v122.js'");
...
ok(manifest.includes('game/ui/character-art-cleanup-v122.js'),'release manifest ships the character cleanup owner');
