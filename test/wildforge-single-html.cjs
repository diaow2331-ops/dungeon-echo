...
assert(html.includes('INVENTORY_SLOT_COUNT=40')&&html.includes('applyEnemyKnockback')&&html.includes('settlementDailyDemand')&&html.includes('buildSettlements'),'v0.17 modular runtime was not bundled');
