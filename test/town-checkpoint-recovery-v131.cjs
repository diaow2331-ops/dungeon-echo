...
assert.deepEqual([...townRules.CHECKPOINTS],[1,11,21,31,41,51,61,71,81,91]);
...
for(const [route,html] of [['zh',zh],['en',en]]) {
  ...
  assert(html.includes('game/domain/town/town-rules-v130.js'),`${route}: town policy authority is shipped after v1.6 transfer`);
