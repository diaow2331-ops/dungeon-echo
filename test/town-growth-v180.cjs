...
for(const [name,html] of [['zh',zh],['en',en]]){
  assert(html.includes('game/domain/town/town-growth-rules-v180.js?v=197'),name+' boots town-growth policy');
  assert(html.indexOf('town-growth-rules-v180.js?v=197')<html.indexOf('game/core/game.js?v=197'),name+' boots town-growth policy before core');
}
