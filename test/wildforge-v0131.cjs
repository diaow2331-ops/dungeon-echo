...
assert.equal(read('wildforge/VERSION').trim(),'0.13.1');
assert(html.includes('<meta name="version" content="0.13.1"'));
assert(data.includes("VERSION = '0.13.1'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0131'"));
assert(html.includes('<meta name="version" content="0.13.1"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.13.1'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0131'"),'v0.9 save key missing');
...
console.log(`wildforge_v0131=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0131=PASS beacon_network=persistent');
...
console.log('wildforge_v0131=PASS route_network=supply-route');
...
console.log('wildforge_v0131=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0131=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0131=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0131=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0131=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0131=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0131=PASS hotfix-save-migration');
