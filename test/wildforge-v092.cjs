...
assert.equal(read('wildforge/VERSION').trim(),'0.9.2');
assert(html.includes('<meta name="version" content="0.9.2"'));
assert(data.includes("VERSION = '0.9.2'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v092'"));
assert(html.includes('<meta name="version" content="0.9.2"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.9.2'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v092'"),'v0.9 save key missing');
...
console.log(`wildforge_v092=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v092=PASS beacon_network=persistent');
...
console.log('wildforge_v092=PASS route_network=supply-route');
...
assert(game.includes("raw.v==='0.9.1'")&&game.includes("LEGACY_SAVE_KEY = 'wildforge.save.v091'"),'v0.9.1 migration chain missing');
...
console.log('wildforge_v092=PASS route_visibility=cross-biome-cargo');
