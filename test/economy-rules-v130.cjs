...
assert.equal(rules.townSupplyPrice(16, 10, .08), 150);
assert.equal(rules.townMarketRestockCost(1), 75);
assert.equal(rules.townMarketRestockCost(10), 255);
...
assert.equal(rules.forgeRetemperCost(100, 3, 0, 0), 190);
assert.equal(rules.forgeRetemperCost(100, 3, 1, 0), 245);
assert.equal(rules.forgeRetemperCost(100, 3, 0, .10), 170);
