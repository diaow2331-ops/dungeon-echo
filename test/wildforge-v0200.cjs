...
assert.equal(read('wildforge/VERSION').trim(),'0.20.0');
assert(html.includes('<meta name="version" content="0.20.0"'));
assert(data.includes("VERSION = '0.20.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0200'"));
assert(html.includes('<meta name="version" content="0.20.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.20.0'"),'data module version must match incubation build');
...
console.log(`wildforge_v0200=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0200=PASS beacon_network=persistent');
...
console.log('wildforge_v0200=PASS route_network=supply-route');
...
console.log('wildforge_v0200=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0200=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0200=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0200=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0200=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0200=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0200=PASS hotfix-save-migration');
...
console.log('wildforge_v0200=PASS visual_foundation=pixel-atlas');
...
assert(html.includes('聚落尺度重做')&&html.includes('真 40 槽背包')&&html.includes('地表无阻树木'),'v0.20 foundation-feel changes are not surfaced on start screen');
console.log('wildforge_v0200=PASS settlement-demand-destinations');
console.log('wildforge_v0200=PASS surface-inventory-knockback-expansion');
console.log('wildforge_v0200=PASS terraria_like_controls=fixed-step-context-use-camera');
...
console.log('wildforge_v0200=PASS foundation_feel=large-settlement-real-pack-pass-through-trees');
