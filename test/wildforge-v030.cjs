...
assert.equal(read('wildforge/VERSION').trim(),'0.3.0');
assert(html.includes('<meta name="version" content="0.3.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
console.log(`wildforge_v030=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
