...
assert.equal(read('wildforge/VERSION').trim(),'0.18.0');
assert(html.includes('<meta name="version" content="0.18.0"'));
assert(data.includes("VERSION = '0.18.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0180'"));
assert(html.includes('<meta name="version" content="0.18.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.18.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0180'"),'v0.9 save key missing');
...
console.log(`wildforge_v0180=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0180=PASS beacon_network=persistent');
...
console.log('wildforge_v0180=PASS route_network=supply-route');
...
console.log('wildforge_v0180=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0180=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0180=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0180=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0180=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0180=PASS armed_haul=cargo-setdown-raiders-escort');
...
console.log('wildforge_v0180=PASS hotfix-save-migration');
...
console.log('wildforge_v0180=PASS visual_foundation=pixel-atlas');
...
const inventoryCss=read('wildforge/inventory-ui.css'),inventoryUi=read('wildforge/src/inventory-ui.js'),combatTuning=read('wildforge/src/combat-tuning.js'),surfaceContent=read('wildforge/src/surface-content.js'),settlementEconomy=read('wildforge/src/settlement-economy.js');
...
assert(html.includes('Drive 像素图集')&&html.includes('聚落商路'),'v0.18 art/settlement loop is not surfaced on start screen');
console.log('wildforge_v0180=PASS settlement-demand-destinations');
console.log('wildforge_v0180=PASS surface-inventory-knockback-expansion');
console.log('wildforge_v0180=PASS terraria_like_controls=fixed-step-context-use-camera');
