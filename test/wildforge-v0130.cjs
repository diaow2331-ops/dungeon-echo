...
assert.equal(read('wildforge/VERSION').trim(),'0.13.0');
assert(html.includes('<meta name="version" content="0.13.0"'));
assert(data.includes("VERSION = '0.13.0'"));
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0130'"));
assert(html.includes('<meta name="version" content="0.13.0"'));assert(html.includes('id="victoryScreen"')&&html.includes('id="continueAfterVictory"'),'v0.3 finale UI missing');
...
assert(data.includes("VERSION = '0.13.0'"),'data module version must match incubation build');
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0130'"),'v0.9 save key missing');
...
console.log(`wildforge_v0130=PASS tiles=${tileEntries} recipes=${recipeEntries} enemies=${enemyEntries}`);
...
console.log('wildforge_v0130=PASS beacon_network=persistent');
...
console.log('wildforge_v0130=PASS route_network=supply-route');
...
console.log('wildforge_v0130=PASS route_visibility=cross-biome-cargo');
...
console.log('wildforge_v0130=PASS frontier_market=regional-arbitrage');
...
console.log('wildforge_v0130=PASS trade_onboarding=early-game');
...
console.log('wildforge_v0130=PASS depot_logistics=production-storage-capacity');
...
console.log('wildforge_v0130=PASS haul_risk=weight-night-spill');
...
console.log('wildforge_v0130=PASS armed_haul=cargo-setdown-raiders-escort');
