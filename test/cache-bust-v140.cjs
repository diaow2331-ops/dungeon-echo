...
ok(authority.version===version&&version==='1.9.4'&&authority.cacheGeneration===194,'authority map locks v1.9.4 cache generation 194');
...
ok(/version:'v36'/.test(runtime),'runtime current follower graph is bootstrap v36');
