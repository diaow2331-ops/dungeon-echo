...
ok(authority.version===version&&version==='1.9.5'&&authority.cacheGeneration===195,'authority map locks v1.9.5 cache generation 195');
...
ok(/version:'v37'/.test(runtime),'runtime current follower graph is bootstrap v37');
