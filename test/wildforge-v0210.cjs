...
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0210'"));
...
assert(game.includes("const SAVE_KEY = 'wildforge.save.v0210'"),'v0.9 save key missing');
...
assert(html.includes('生态氛围层')&&html.includes('活聚落')&&html.includes('可视化货站'),'v0.21 visual-spiral changes are not surfaced on start screen');
...
console.log('wildforge_v0210=PASS visual_spiral=biomes-settlements-depots');
